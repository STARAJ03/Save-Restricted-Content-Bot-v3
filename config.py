...
MONGO_DB = os.getenv("MONGO_DB", "mongodb+srv://STAR10:<iamagamer>@cluster0.w2snkuc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FREEMIUM_LIMIT = int(os.getenv("FREEMIUM_LIMIT", "500000000000"))
